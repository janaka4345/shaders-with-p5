...
import fsimage2 from "../shaders/fragment-image-2"; //image processing with shaders working
let cw = 400;
let ch = 400;
let screen;
let myShader;
...
export default function Canvas5Pixel(props) {
...
function setup(p5) {
  return () => {
    ...
    myShader = p5.createShader(vs, fsimage2);
    p5.shader(myShader);
